    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-black text-white font-sans selection:bg-blue-500/30">
      <div className="relative w-full max-w-2xl px-6 py-24 text-center">
        ...
        <p className="text-lg text-zinc-400 mb-12 max-w-md mx-auto leading-relaxed">
          High-precision football prediction engine powered by Poisson distribution and Elo ratings. 
          Analyzing 25+ European leagues in real-time.
        </p>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/dashboard"
            className="group relative flex h-14 items-center justify-center gap-2 rounded-xl bg-white px-8 text-black transition-all hover:bg-zinc-200 active:scale-95 w-full sm:w-auto font-bold"
          >
            Open Dashboard
        ...
        <div className="mt-24 grid grid-cols-3 gap-8 border-t border-zinc-900 pt-12">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-500 uppercase tracking-widest mt-1">Analysis</p>
          </div>
        </div>
      </div>
    </div>
